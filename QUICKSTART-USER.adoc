...
// Replace unified-dataset-vocab, Unified Dataset Vocab — See README.adoc for details., just run, Unified Dataset Vocab started successfully. with actuals
= unified-dataset-vocab — Quick Start for Users
:toc:
:toclevels: 2

== What is unified-dataset-vocab?

Unified Dataset Vocab — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./unified-dataset-vocab-portable
----
...
[source]
----
Unified Dataset Vocab started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/unified-dataset-vocab/wiki
