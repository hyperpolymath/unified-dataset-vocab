...
git clone https://github.com/hyperpolymath/unified-dataset-vocab.git cd
...
toolbox create unified-dataset-vocab-dev toolbox enter
unified-dataset-vocab-dev # Install dependencies manually
...
unified-dataset-vocab/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
