{
  description = "unified-dataset-vocab - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 unified-dataset-vocab development environment"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P unified-dataset-vocab.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/unified-dataset-vocab $out/bin/  # Rust
            # cp bin/unified-dataset-vocab $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/unified-dataset-vocab";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-unified-dataset-vocab" {
