...
|link:https://github.com/hyperpolymath/rescript-safe-dom[rescript-safe-dom]
...
See link:https://github.com/hyperpolymath/rescript-safe-dom[rescript-safe-dom documentation] for full details.
