...
# Justfile for unified-dataset-vocab
...
doctor:
    @echo "Running diagnostics for unified-dataset-vocab..."
...
tour:
    @echo "=== unified-dataset-vocab Tour ==="
    @echo ""
...
help-me:
    @echo "=== unified-dataset-vocab Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/unified-dataset-vocab/issues/new"
    @echo ""
...
# LLM context dump
llm-context:
    @echo "Project: unified-dataset-vocab"
